...
must_haves:
  ...
  key_links:
    ...
    - from: "pkg/warplib/manager.go:ResumeDownload"
      ...
      via: "EXISTING function — already implemented. ResumeDownload calls it for item validation. DO NOT reimplement."
...
<feature>
  ...
  <behavior>
    ...
    18. ResumeDownload with item.Protocol==ProtoHTTP still uses initDownloader path (zero regression)
