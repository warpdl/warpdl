...
- [x] 4.1 Coverage check - all packages 80%+ (warplib: 87.1%, api: 88.4%, warpcli: 85.4%)
- [x] 4.2 Race detector pass - no races detected
- [x] 4.3 Lint and format - 3 files formatted
